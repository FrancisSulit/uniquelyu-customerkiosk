...
import com.mycompany.kioskgui.utils.LoginHandler;
...
public class EmployeeLogin extends javax.swing.JFrame {
    ...
    public EmployeeLogin() {
        ...
        mainPanel.add(jPanel1, "loginPanel");
        mainPanel.add(jPanel2, "itemPanel");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String inputPassword = new String(jPasswordField1.getPassword()); // safer than getText()

        File file = new File("login-data/LoginDetails.txt");

        try {
            if (!file.exists() || file.length() == 0) {
                // If no login data, prompt to create one
                String newUsername = JOptionPane.showInputDialog(this, "No login found. Set a new Username:");
                String newPassword = JOptionPane.showInputDialog(this, "Set a new Password:");

                if (newUsername != null && newPassword != null && !newUsername.isEmpty() && !newPassword.isEmpty()) {
                    // saveDetails(newUsername, newPassword);
                    JOptionPane.showMessageDialog(this, "Login saved. Please restart the program.");
                } else {
                    JOptionPane.showMessageDialog(this, "Username and Password cannot be empty.");
                }
            } else {
                String[] stored = LoginHandler.loadDetails();

                if (stored != null &&
                    inputUsername.equals(stored[0]) &&
                    inputPassword.equals(stored[1])) {

                    // Switch to panel2 (successful login)
                    mainPanel.removeAll();
